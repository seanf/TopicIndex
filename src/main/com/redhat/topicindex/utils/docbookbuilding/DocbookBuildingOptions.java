...
public class DocbookBuildingOptions
{
	...
	/** The value assigned to the FilterOptionName field in the FilterOption table for the "Makefile PRODUCT" option */
	public static String DOCBOOK_BUILDING_OPTION_MAKEFILE_PRODUCT = "Makefile PRODUCT";
	/** The value assigned to the FilterOptionName field in the FilterOption table for the "Makefile PROD_VERSION" option */
	...
	/** The value assigned to the FilterOptionName field in the FilterOption table for the "Makefile BOOKS" option */
	public static String DOCBOOK_BUILDING_OPTION_MAKEFILE_BOOKS = "Makefile BOOKS";
	/** The value assigned to the FilterOptionName field in the FilterOption table for the "Makefile VERSION" option */
	public static String DOCBOOK_BUILDING_OPTION_MAKEFILE_VERSION = "Makefile VERSION";
	/** The value assigned to the FilterOptionName field in the FilterOption table for the "Makefile RELEASE" option */
	...
	public void setMakefileProductOption(String makefileProductOption)
	{
	...
	public void setMakefileProdVersionOption(String makefileProdVersionOption)
	{
	...
	public void setMakefileLangOption(String makefileLangOption)
	{
	...
	public void setMakefileBooksOption(String makefileooksOption)
	{
	...
	public void setMakefileVersionOption(String makefileVersionOption)
	{
	...
	public void setMakefileReleaseOption(String makefileReleaseOption)
	{
